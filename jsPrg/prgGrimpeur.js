...
function prgGrimpeur() {
    ...
    if (nbPrgT == 4) {
        ...
        if (nbPrgJ >= 3) {if (document.getElementById(nbObjectif - 95)) {document.getElementById(nbObjectif - 95).style.backgroundColor = "yellow"}}   
        ...
        if (nbPrgJ >= 4) {if (document.getElementById(nbObjectif - 89)) {document.getElementById(nbObjectif - 89).style.backgroundColor = "red"}}   
        ...
        if (nbPrgJ >= 3) {if (document.getElementById(nbObjectif - 85)) {document.getElementById(nbObjectif - 85).style.backgroundColor = "#01FE0A"}} 
        ...
        if (nbPrgJ >= 3) {if (document.getElementById(nbObjectif - 81)) {document.getElementById(nbObjectif - 81).style.backgroundColor = "orange"}}   
        if (nbPrgJ >= 6) {if (document.getElementById(nbObjectif - 80)) {document.getElementById(nbObjectif - 80).style.backgroundColor = "green"}}  
        if (nbPrgJ >= 5) {if (document.getElementById(nbObjectif - 79)) {document.getElementById(nbObjectif - 79).style.backgroundColor = "red"}}
        ...
        if (nbPrgJ >= 5) {if (document.getElementById(nbObjectif - 72)) {document.getElementById(nbObjectif - 72).style.backgroundColor = ""}}
        ...
        if (nbPrgJ >= 3) {if (document.getElementById(nbObjectif - 64)) {document.getElementById(nbObjectif - 64).style.backgroundColor = "yellow"}} 
        ...
        if (nbPrgJ >= 4) {if (document.getElementById(nbObjectif - 61)) {document.getElementById(nbObjectif - 61).style.backgroundColor = "red"}}   
        if (nbPrgJ >= 3) {if (document.getElementById(nbObjectif - 60)) {document.getElementById(nbObjectif - 60).style.backgroundColor = "yellow"}}   
        ...
        if (nbPrgJ >= 6) {if (document.getElementById(nbObjectif - 24)) {document.getElementById(nbObjectif - 24).style.backgroundColor = "orange"}}  
        ...
        if (nbPrgJ >= 4) {if (document.getElementById(nbObjectif - 68)) {document.getElementById(nbObjectif - 68).style.backgroundColor = "red"}}   
        if (nbPrgJ >= 3) {if (document.getElementById(nbObjectif - 67)) {document.getElementById(nbObjectif - 67).style.backgroundColor = "yellow"}}   
        if (nbPrgJ >= 6) {if (document.getElementById(nbObjectif - 66)) {document.getElementById(nbObjectif - 66).style.backgroundColor = "red"}}  
        ...
        if (nbPrgJ >= 5) {if (document.getElementById(nbObjectif - 58)) {document.getElementById(nbObjectif - 58).style.backgroundColor = "orange"}}
...
if (nbPrgT == 4) {
        //semaine 1     
        document.getElementById("10001").style.backgroundColor = "green"
        document.getElementById("10002").style.backgroundColor = ""
        document.getElementById("10003").style.backgroundColor = "green"
        document.getElementById("10004").style.backgroundColor = "green"
        document.getElementById("10005").style.backgroundColor = "green"
        document.getElementById("10006").style.backgroundColor = "green"
        document.getElementById("10007").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 111)) { document.getElementById(12001).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 110)) { document.getElementById(12002).innerText = "";}
        if(document.getElementById(nbObjectif - 109)) { document.getElementById(12003).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 108)) { document.getElementById(12004).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 107)) { document.getElementById(12005).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 106)) { document.getElementById(12006).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 105)) { document.getElementById(12007).innerText = "séance d'endurance";}
        //semaine 2       
        document.getElementById("10008").style.backgroundColor = ""
        document.getElementById("10009").style.backgroundColor = "green"
        document.getElementById("10010").style.backgroundColor = "red"
        document.getElementById("10011").style.backgroundColor = "green"
        document.getElementById("10012").style.backgroundColor = "yellow"
        document.getElementById("10013").style.backgroundColor = "green"
        document.getElementById("10014").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 104)) { document.getElementById(12008).innerText = "";}
        if(document.getElementById(nbObjectif - 103)) { document.getElementById(12009).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 102)) { document.getElementById(12010).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 101)) { document.getElementById(12011).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 100)) { document.getElementById(12012).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 99)) { document.getElementById(12013).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 98)) { document.getElementById(12014).innerText = "séance d'endurance";}
        //semaine 3       
        document.getElementById("10015").style.backgroundColor = ""
        document.getElementById("10016").style.backgroundColor = "red"
        document.getElementById("10017").style.backgroundColor = "yellow"
        document.getElementById("10018").style.backgroundColor = "orange"
        document.getElementById("10019").style.backgroundColor = "green"
        document.getElementById("10020").style.backgroundColor = "green"
        document.getElementById("10021").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 97)) {document.getElementById(12015).innerText = "";}
        if(document.getElementById(nbObjectif - 96)) {document.getElementById(12016).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 95)) {document.getElementById(12017).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 94)) {document.getElementById(12018).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 93)) {document.getElementById(12019).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 92)) {document.getElementById(12020).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 91)) {document.getElementById(12021).innerText = "séance d'endurance";}
        //semaine 4      
        document.getElementById("10022").style.backgroundColor = ""
        document.getElementById("10023").style.backgroundColor = "red"
        document.getElementById("10024").style.backgroundColor = "yellow"
        document.getElementById("10025").style.backgroundColor = "green"
        document.getElementById("10026").style.backgroundColor = "red"
        document.getElementById("10027").style.backgroundColor = "green"
        document.getElementById("10028").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 90)) { document.getElementById(12022).innerText = "";}
        if(document.getElementById(nbObjectif - 89)) { document.getElementById(12023).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 88)) { document.getElementById(12024).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 87)) { document.getElementById(12025).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 86)) { document.getElementById(12026).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 85)) { document.getElementById(12027).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 84)) { document.getElementById(12028).innerText = "séance d'endurance";}
        //semaine 5     
        document.getElementById("10029").style.backgroundColor = ""
        document.getElementById("10030").style.backgroundColor = "red"
        document.getElementById("10031").style.backgroundColor = "orange"
        document.getElementById("10032").style.backgroundColor = "green"
        document.getElementById("10033").style.backgroundColor = "red"
        document.getElementById("10034").style.backgroundColor = "green"
        document.getElementById("10035").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 83)) { document.getElementById(12029).innerText = "";}
        if(document.getElementById(nbObjectif - 82)) { document.getElementById(12030).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 81)) { document.getElementById(12031).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 80)) { document.getElementById(12032).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 79)) { document.getElementById(12033).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 78)) { document.getElementById(12034).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 77)) { document.getElementById(12035).innerText = "séance d'endurance";}
        //semaine 6     
        document.getElementById("10036").style.backgroundColor = ""
        document.getElementById("10037").style.backgroundColor = "yellow"
        document.getElementById("10038").style.backgroundColor = "green"
        document.getElementById("10039").style.backgroundColor = "red"
        document.getElementById("10040").style.backgroundColor = ""
        document.getElementById("10041").style.backgroundColor = "green"
        document.getElementById("10042").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 76)) { document.getElementById(12036).innerText = "";}
        if(document.getElementById(nbObjectif - 75)) { document.getElementById(12037).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 74)) { document.getElementById(12038).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 73)) { document.getElementById(12039).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 72)) { document.getElementById(12040).innerText = "";}
        if(document.getElementById(nbObjectif - 71)) { document.getElementById(12041).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 70)) { document.getElementById(12042).innerText = "séance d'endurance";}
        //semaine 7       
        document.getElementById("10043").style.backgroundColor = ""
        document.getElementById("10044").style.backgroundColor = "red"
        document.getElementById("10045").style.backgroundColor = "yellow"
        document.getElementById("10046").style.backgroundColor = "green"
        document.getElementById("10047").style.backgroundColor = "yellow"
        document.getElementById("10048").style.backgroundColor = "yellow"
        document.getElementById("10049").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 69)) { document.getElementById(12043).innerText = "";}
        if(document.getElementById(nbObjectif - 68)) { document.getElementById(12044).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 67)) { document.getElementById(12045).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 66)) { document.getElementById(12046).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 65)) { document.getElementById(12047).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 64)) { document.getElementById(12048).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 63)) { document.getElementById(12049).innerText = "séance d'endurance";}
        //semaine 8       
        document.getElementById("10050").style.backgroundColor = ""
        document.getElementById("10051").style.backgroundColor = "red"
        document.getElementById("10052").style.backgroundColor = "yellow"
        document.getElementById("10053").style.backgroundColor = "yellow"
        document.getElementById("10054").style.backgroundColor = "green"
        document.getElementById("10055").style.backgroundColor = "yellow"
        document.getElementById("10056").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 62)) { document.getElementById(12050).innerText = "";}
        if(document.getElementById(nbObjectif - 61)) { document.getElementById(12051).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 60)) { document.getElementById(12052).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 59)) { document.getElementById(12053).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 58)) { document.getElementById(12054).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 57)) { document.getElementById(12055).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 56)) { document.getElementById(12056).innerText = "séance d'endurance";}
        //semaine 9     
        document.getElementById("10057").style.backgroundColor = ""
        document.getElementById("10058").style.backgroundColor = "red"
        document.getElementById("10059").style.backgroundColor = "orange"
        document.getElementById("10060").style.backgroundColor = "yellow"
        document.getElementById("10061").style.backgroundColor = "green"
        document.getElementById("10062").style.backgroundColor = "yellow"
        document.getElementById("10063").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 55)) { document.getElementById(12057).innerText = "";}
        if(document.getElementById(nbObjectif - 54)) { document.getElementById(12058).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 53)) { document.getElementById(12059).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 52)) { document.getElementById(12060).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 51)) { document.getElementById(12061).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 50)) { document.getElementById(12062).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 49)) { document.getElementById(12063).innerText = "séance d'endurance";}
        //semaine 10      
        document.getElementById("10064").style.backgroundColor = ""
        document.getElementById("10065").style.backgroundColor = "red"
        document.getElementById("10066").style.backgroundColor = "orange"
        document.getElementById("10067").style.backgroundColor = "green"
        document.getElementById("10068").style.backgroundColor = "green"
        document.getElementById("10069").style.backgroundColor = "yellow"
        document.getElementById("10070").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 48)) { document.getElementById(12064).innerText = "";}
        if(document.getElementById(nbObjectif - 47)) { document.getElementById(12065).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 46)) { document.getElementById(12066).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 45)) { document.getElementById(12067).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 44)) { document.getElementById(12068).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 43)) { document.getElementById(12069).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 42)) { document.getElementById(12070).innerText = "séance d'endurance";}
        //semaine 11     
        document.getElementById("10071").style.backgroundColor = ""
        document.getElementById("10072").style.backgroundColor = "red"
        document.getElementById("10073").style.backgroundColor = "orange"
        document.getElementById("10074").style.backgroundColor = "green"
        document.getElementById("10075").style.backgroundColor = "orange"
        document.getElementById("10076").style.backgroundColor = "orange"
        document.getElementById("10077").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 41)) { document.getElementById(12071).innerText = "";}
        if(document.getElementById(nbObjectif - 40)) { document.getElementById(12072).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 39)) { document.getElementById(12073).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 38)) { document.getElementById(12074).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 37)) { document.getElementById(12075).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 36)) { document.getElementById(12076).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 35)) { document.getElementById(12077).innerText = "séance d'endurance";}
        //semaine 12   
        document.getElementById("10078").style.backgroundColor = ""
        document.getElementById("10079").style.backgroundColor = "red"
        document.getElementById("10080").style.backgroundColor = "orange"
        document.getElementById("10081").style.backgroundColor = "orange"
        document.getElementById("10082").style.backgroundColor = "green"
        document.getElementById("10083").style.backgroundColor = "orange"
        document.getElementById("10084").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 34)) { document.getElementById(12078).innerText = "";}
        if(document.getElementById(nbObjectif - 33)) { document.getElementById(12079).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 32)) { document.getElementById(12080).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 31)) { document.getElementById(12081).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 30)) { document.getElementById(12082).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 29)) { document.getElementById(12083).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 28)) { document.getElementById(12084).innerText = "séance d'endurance";}
        //semaine 13       
        document.getElementById("10085").style.backgroundColor = ""
        document.getElementById("10086").style.backgroundColor = "red"
        document.getElementById("10087").style.backgroundColor = "yellow"
        document.getElementById("10088").style.backgroundColor = "orange"
        document.getElementById("10089").style.backgroundColor = "green"
        document.getElementById("10090").style.backgroundColor = "orange"
        document.getElementById("10091").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 27)) { document.getElementById(12085).innerText = "";}
        if(document.getElementById(nbObjectif - 26)) { document.getElementById(12086).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 25)) { document.getElementById(12087).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 24)) { document.getElementById(12088).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 23)) { document.getElementById(12089).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 22)) { document.getElementById(12090).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 21)) { document.getElementById(12091).innerText = "séance d'endurance";}
        //semaine 14    
        document.getElementById("10092").style.backgroundColor = ""
        document.getElementById("10093").style.backgroundColor = "red"
        document.getElementById("10094").style.backgroundColor = "yellow"
        document.getElementById("10095").style.backgroundColor = "green"
        document.getElementById("10096").style.backgroundColor = "green"
        document.getElementById("10097").style.backgroundColor = "orange"
        document.getElementById("10098").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 20)) { document.getElementById(12092).innerText = "";}
        if(document.getElementById(nbObjectif - 19)) { document.getElementById(12093).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 18)) { document.getElementById(12094).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 17)) { document.getElementById(12095).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 16)) { document.getElementById(12096).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 15)) { document.getElementById(12097).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 14)) { document.getElementById(12098).innerText = "séance d'endurance";}
        //semaine 15     
        document.getElementById("10099").style.backgroundColor = "red"
        document.getElementById("10101").style.backgroundColor = "green"
        document.getElementById("10104").style.backgroundColor = "orange"
        if(document.getElementById(nbObjectif - 13)) {document.getElementById(12099).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 12)) { document.getElementById(12100).innerText = "";}
        if(document.getElementById(nbObjectif - 11)) { document.getElementById(12101).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 10)) { document.getElementById(12102).innerText = "";}
        if(document.getElementById(nbObjectif - 9)) { document.getElementById(12103).innerText = "";}
        if(document.getElementById(nbObjectif - 8)) { document.getElementById(12104).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 7)) { document.getElementById(12105).innerText = "";}
        //semaine 16      
        document.getElementById("10106").style.backgroundColor = "green"
        document.getElementById("10108").style.backgroundColor = "orange"
        document.getElementById("10111").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 6)) { document.getElementById(12106).innerText = "";}
        if(document.getElementById(nbObjectif - 5)) { document.getElementById(12107).innerText = "";}
        if(document.getElementById(nbObjectif - 4)) { document.getElementById(12108).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 3)) { document.getElementById(12109).innerText = "";}
        if(document.getElementById(nbObjectif - 2)) { document.getElementById(12110).innerText = "";}
        if(document.getElementById(nbObjectif - 1)) { document.getElementById(12111).innerText = "séance de débloquage";}
    }
        ...
        document.getElementById("10006").style.backgroundColor = "green"
        document.getElementById("10007").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 83)) { document.getElementById(12001).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 82)) { document.getElementById(12002).innerText = "";}
        if(document.getElementById(nbObjectif - 81)) { document.getElementById(12003).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 80)) { document.getElementById(12004).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 79)) { document.getElementById(12005).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 78)) { document.getElementById(12006).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 77)) { document.getElementById(12007).innerText = "séance d'endurance";}
        //semaine 2       
        document.getElementById("10008").style.backgroundColor = ""
        document.getElementById("10009").style.backgroundColor = "green"
        document.getElementById("10010").style.backgroundColor = "red"
        ...
        document.getElementById("10013").style.backgroundColor = "green"
        document.getElementById("10014").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 76)) { document.getElementById(12008).innerText = "";}
        if(document.getElementById(nbObjectif - 75)) { document.getElementById(12009).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 74)) { document.getElementById(120010).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 73)) { document.getElementById(120011).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 72)) { document.getElementById(120012).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 71)) { document.getElementById(120013).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 70)) { document.getElementById(120014).innerText = "séance d'endurance";}
        //semaine 3       
        document.getElementById("10015").style.backgroundColor = ""
        document.getElementById("10016").style.backgroundColor = "red"
        document.getElementById("10017").style.backgroundColor = "yellow"
        document.getElementById("10018").style.backgroundColor = "red"
        document.getElementById("10019").style.backgroundColor = "red"
        document.getElementById("10020").style.backgroundColor = "green"
        document.getElementById("10021").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 69)) { document.getElementById(120015).innerText = "";}
        if(document.getElementById(nbObjectif - 68)) { document.getElementById(120016).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 67)) { document.getElementById(120017).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 66)) { document.getElementById(120018).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 65)) { document.getElementById(120019).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 64)) { document.getElementById(120020).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 63)) { document.getElementById(120021).innerText = "séance d'endurance";}
        //semaine 4      
        document.getElementById("10022").style.backgroundColor = ""
        document.getElementById("10023").style.backgroundColor = "green"
        document.getElementById("10024").style.backgroundColor = "red"
        document.getElementById("10025").style.backgroundColor = "green"
        document.getElementById("10026").style.backgroundColor = ""
        document.getElementById("10027").style.backgroundColor = "green"
        document.getElementById("10028").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 62)) { document.getElementById(120022).innerText = "";}
        if(document.getElementById(nbObjectif - 61)) { document.getElementById(120023).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 60)) { document.getElementById(120024).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 59)) { document.getElementById(120025).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 58)) { document.getElementById(120026).innerText = "";}
        if(document.getElementById(nbObjectif - 57)) { document.getElementById(120027).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 56)) { document.getElementById(120028).innerText = "séance d'endurance";}
        //semaine 5     
        document.getElementById("10029").style.backgroundColor = ""
        document.getElementById("10030").style.backgroundColor = "red"
        document.getElementById("10031").style.backgroundColor = "yellow"
        document.getElementById("10032").style.backgroundColor = "green"
        document.getElementById("10033").style.backgroundColor = "yellow"
        document.getElementById("10034").style.backgroundColor = "yellow"
        document.getElementById("10035").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 55)) { document.getElementById(120029).innerText = "";}
        if(document.getElementById(nbObjectif - 54)) { document.getElementById(120030).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 53)) { document.getElementById(120031).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 52)) { document.getElementById(120032).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 51)) { document.getElementById(120033).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 50)) { document.getElementById(120034).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 49)) { document.getElementById(120035).innerText = "séance d'endurance";}
        //semaine 6     
        document.getElementById("10036").style.backgroundColor = ""
        document.getElementById("10037").style.backgroundColor = "red"
        document.getElementById("10038").style.backgroundColor = "yellow"
        document.getElementById("10039").style.backgroundColor = "yellow"
        document.getElementById("10040").style.backgroundColor = "green"
        document.getElementById("10041").style.backgroundColor = "yellow"
        document.getElementById("10042").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 48)) { document.getElementById(120036).innerText = "";}
        if(document.getElementById(nbObjectif - 47)) { document.getElementById(120037).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 46)) { document.getElementById(120038).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 45)) { document.getElementById(120039).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 44)) { document.getElementById(120040).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 43)) { document.getElementById(120041).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 42)) { document.getElementById(120042).innerText = "séance d'endurance";}
        //semaine 7       
        document.getElementById("10043").style.backgroundColor = ""
        document.getElementById("10044").style.backgroundColor = "red"
        document.getElementById("10045").style.backgroundColor = "orange"
        document.getElementById("10046").style.backgroundColor = "green"
        document.getElementById("10047").style.backgroundColor = "green"
        document.getElementById("10048").style.backgroundColor = "yellow"
        document.getElementById("10049").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 41)) { document.getElementById(120043).innerText = "";}
        if(document.getElementById(nbObjectif - 40)) { document.getElementById(120044).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 39)) { document.getElementById(120045).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 38)) { document.getElementById(120046).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 37)) { document.getElementById(120047).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 36)) { document.getElementById(120048).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 35)) { document.getElementById(120049).innerText = "séance d'endurance";}
        //semaine 8       
        document.getElementById("10050").style.backgroundColor = ""
        document.getElementById("10051").style.backgroundColor = "red"
        document.getElementById("10052").style.backgroundColor = "orange"
        document.getElementById("10053").style.backgroundColor = "green"
        document.getElementById("10054").style.backgroundColor = "orange"
        document.getElementById("10055").style.backgroundColor = "orange"
        document.getElementById("10056").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 34)) { document.getElementById(120050).innerText = "";}
        if(document.getElementById(nbObjectif - 33)) { document.getElementById(120051).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 32)) { document.getElementById(120052).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 31)) { document.getElementById(120053).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 30)) { document.getElementById(120054).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 29)) { document.getElementById(120055).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 28)) { document.getElementById(120056).innerText = "séance d'endurance";}
        //semaine 9     
        document.getElementById("10057").style.backgroundColor = ""
        document.getElementById("10058").style.backgroundColor = "red"
        document.getElementById("10059").style.backgroundColor = "orange"
        document.getElementById("10060").style.backgroundColor = "orange"
        document.getElementById("10061").style.backgroundColor = "green"
        document.getElementById("10062").style.backgroundColor = "orange"
        document.getElementById("10063").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 27)) { document.getElementById(120057).innerText = "";}
        if(document.getElementById(nbObjectif - 26)) { document.getElementById(120058).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 25)) { document.getElementById(120059).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 24)) { document.getElementById(120060).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 23)) { document.getElementById(120061).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 22)) { document.getElementById(120062).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 21)) { document.getElementById(120063).innerText = "séance d'endurance";}
        //semaine 10      
        document.getElementById("10064").style.backgroundColor = ""
        document.getElementById("10065").style.backgroundColor = "red"
        document.getElementById("10066").style.backgroundColor = "yellow"
        document.getElementById("10067").style.backgroundColor = "green"
        document.getElementById("10068").style.backgroundColor = "green"
        document.getElementById("10069").style.backgroundColor = "orange"
        document.getElementById("10070").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 20)) { document.getElementById(120064).innerText = "";}
        if(document.getElementById(nbObjectif - 19)) { document.getElementById(120065).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 18)) { document.getElementById(120066).innerText = "";}
        if(document.getElementById(nbObjectif - 17)) { document.getElementById(120067).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 16)) { document.getElementById(120068).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 15)) { document.getElementById(120069).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 14)) { document.getElementById(120070).innerText = "séance d'endurance";}
        //semaine 11     
        document.getElementById("10071").style.backgroundColor = "red"
        document.getElementById("10073").style.backgroundColor = "green"
        document.getElementById("10076").style.backgroundColor = "orange"
        if(document.getElementById(nbObjectif - 13)) { document.getElementById(120071).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 12)) { document.getElementById(120072).innerText = "";}
        if(document.getElementById(nbObjectif - 11)) { document.getElementById(120073).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 10)) { document.getElementById(120074).innerText = "";}
        if(document.getElementById(nbObjectif - 9)) { document.getElementById(120075).innerText = "";}
        if(document.getElementById(nbObjectif - 8)) { document.getElementById(120076).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 7)) { document.getElementById(120077).innerText = "";}
        //semaine 12   
        document.getElementById("10078").style.backgroundColor = "green"
        document.getElementById("10080").style.backgroundColor = "orange"
        document.getElementById("10083").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 6)) { document.getElementById(120078).innerText = "";}
        if(document.getElementById(nbObjectif - 5)) { document.getElementById(120079).innerText = "";}
        if(document.getElementById(nbObjectif - 4)) { document.getElementById(120080).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 3)) { document.getElementById(120081).innerText = "";}
        if(document.getElementById(nbObjectif - 2)) { document.getElementById(120082).innerText = "";}
        if(document.getElementById(nbObjectif - 1)) { document.getElementById(120083).innerText = "";}
    }
        ...
        document.getElementById("10006").style.backgroundColor = "green"
        document.getElementById("10007").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 55)) { document.getElementById(12001).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 54)) { document.getElementById(12002).innerText = "";}
        if(document.getElementById(nbObjectif - 53)) { document.getElementById(12003).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 52)) { document.getElementById(12004).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 51)) { document.getElementById(12005).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 50)) { document.getElementById(12006).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 49)) { document.getElementById(12007).innerText = "séance d'endurance";}
        //semaine 2       
        document.getElementById("10008").style.backgroundColor = ""
        document.getElementById("10009").style.backgroundColor = "green"
        document.getElementById("10010").style.backgroundColor = "red"
        document.getElementById("10011").style.backgroundColor = "green"
        document.getElementById("10012").style.backgroundColor = "green"
        document.getElementById("10013").style.backgroundColor = "yellow"
        document.getElementById("10014").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 48)) { document.getElementById(12008).innerText = "";}
        if(document.getElementById(nbObjectif - 47)) { document.getElementById(12009).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 46)) { document.getElementById(120010).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 45)) { document.getElementById(120011).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 44)) { document.getElementById(120012).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 43)) { document.getElementById(120013).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 42)) { document.getElementById(120014).innerText = "séance d'endurance";}
        //semaine 3       
        document.getElementById("10015").style.backgroundColor = ""
        document.getElementById("10016").style.backgroundColor = "red"
        document.getElementById("10017").style.backgroundColor = "yellow"
        document.getElementById("10018").style.backgroundColor = "green"
        document.getElementById("10019").style.backgroundColor = "yellow"
        document.getElementById("10020").style.backgroundColor = "yellow"
        document.getElementById("10021").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 41)) { document.getElementById(120015).innerText = "";}
        if(document.getElementById(nbObjectif - 40)) { document.getElementById(120016).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 39)) { document.getElementById(120017).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 38)) { document.getElementById(120018).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 37)) { document.getElementById(120019).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 36)) { document.getElementById(120020).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 35)) { document.getElementById(120021).innerText = "séance d'endurance";}
        //semaine 4      
        document.getElementById("10022").style.backgroundColor = ""
        document.getElementById("10023").style.backgroundColor = "red"
        document.getElementById("10024").style.backgroundColor = "yellow"
        document.getElementById("10025").style.backgroundColor = "orange"
        document.getElementById("10026").style.backgroundColor = "green"
        document.getElementById("10027").style.backgroundColor = "yellow"
        document.getElementById("10028").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 34)) { document.getElementById(120022).innerText = "";}
        if(document.getElementById(nbObjectif - 33)) { document.getElementById(120023).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 32)) { document.getElementById(120024).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 31)) { document.getElementById(120025).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 30)) { document.getElementById(120026).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 29)) { document.getElementById(120027).innerText = "séance de seuil";}
        if(document.getElementById(nbObjectif - 28)) { document.getElementById(120028).innerText = "séance d'endurance";}
        //semaine 5     
        document.getElementById("10029").style.backgroundColor = ""
        document.getElementById("10030").style.backgroundColor = "red"
        document.getElementById("10031").style.backgroundColor = "orange"
        document.getElementById("10032").style.backgroundColor = "green"
        document.getElementById("10033").style.backgroundColor = "orange"
        document.getElementById("10034").style.backgroundColor = "orange"
        document.getElementById("10035").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 27)) {  document.getElementById(120029).innerText = "";}
        if(document.getElementById(nbObjectif - 26)) {  document.getElementById(120030).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 25)) { document.getElementById(120031).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 24)) { document.getElementById(120032).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 23)) { document.getElementById(120033).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 22)) { document.getElementById(120034).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 21)) { document.getElementById(120035).innerText = "séance d'endurance";}
        //semaine 6     
        document.getElementById("10036").style.backgroundColor = ""
        document.getElementById("10037").style.backgroundColor = "red"
        document.getElementById("10038").style.backgroundColor = "orange"
        document.getElementById("10039").style.backgroundColor = "orange"
        document.getElementById("10040").style.backgroundColor = "green"
        document.getElementById("10041").style.backgroundColor = "orange"
        document.getElementById("10042").style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 20)) { document.getElementById(120036).innerText = "";}
        if(document.getElementById(nbObjectif - 19)) { document.getElementById(120037).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 18)) { document.getElementById(120038).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 17)) { document.getElementById(120039).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 16)) { document.getElementById(120040).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 15)) {document.getElementById(120041).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 14)) {document.getElementById(120042).innerText = "séance d'endurance";}
        //semaine 7       
        document.getElementById("10043").style.backgroundColor = "red"
        document.getElementById("10045").style.backgroundColor = "green"
        document.getElementById("10048").style.backgroundColor = "orange"
        if(document.getElementById(nbObjectif - 13)) {document.getElementById(120043).innerText = "séance de sprint";}
        if(document.getElementById(nbObjectif - 12)) {document.getElementById(120044).innerText = "";}
        if(document.getElementById(nbObjectif - 11)) {document.getElementById(120045).innerText = "séance d'endurance";}
        if(document.getElementById(nbObjectif - 10)) {document.getElementById(120046).innerText = "";}
        if(document.getElementById(nbObjectif - 9)) {document.getElementById(120047).innerText = "";}
        if(document.getElementById(nbObjectif - 8)) {document.getElementById(120048).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 7)) {document.getElementById(120049).innerText = "";}
        //semaine 8       
        document.getElementById("10050").style.backgroundColor = "green"
        document.getElementById("10052").style.backgroundColor = "orange"
        document.getElementById("10055") .style.backgroundColor = "green"
        if(document.getElementById(nbObjectif - 6)) {document.getElementById(120050).innerText = "";}
        if(document.getElementById(nbObjectif - 5)) {document.getElementById(120051).innerText = "";}
        if(document.getElementById(nbObjectif - 4)) {document.getElementById(120052).innerText = "séance de PMA";}
        if(document.getElementById(nbObjectif - 3)) {document.getElementById(120053).innerText = "";}
