function enduranceFondamentale(tps) {
    ...
    return {titre: "ENDURANCE FONDAMENTALE", seance: seance, type: "time", typeSeance: "Endurance", Z: 1};
}
...
function enduranceHaute(tps) {
    ...
    return {titre: "ENDURANCE HAUTE", seance: seance, type: "time", typeSeance: "Endurance", Z: 2};
}