...
lcExo = () => {
    ...
    if (nbPrgT == 4) {
        ...
        localStorage.exoClr69 = "green"

        localStorage.exo70 = "séance de PMA"
        localStorage.exoClr70 = "orange"
        ...
        localStorage.exoClr76 = "green"

        localStorage.exo77 = "séance de PMA"
        localStorage.exoClr77 = "orange"
        ...
        localStorage.exoClr10 = "green"

        if (nbPrgJ >= 6) {
            localStorage.exo11 = "séance de sprint"
            localStorage.exoClr11 = "red"
        }
        else {
            localStorage.exo11 = "jour de repos"
            localStorage.exoClr11 = ""
